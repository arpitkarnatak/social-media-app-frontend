    ...
    return (
        <CreatePostSectionStyle>
            ...
            <MinimalStyledForm onSubmit={handleCreateComment}>
                <MinimalTextInput maxLength={140} placeholder="Comment" value={body} onChange={(e) => setBody(e.target.value)} disabled={!!!authenticatedUser.data}>
                </MinimalTextInput>
                <div style={{ width: '100%', display: 'flex', justifyContent: 'flex-end', gap: '12px', alignItems: 'baseline' }}>
                    <TextButton type='submit' disabled={!!isCreatingComment || body.length < 3 || !!!authenticatedUser.data} style={{ width: 'fit-content' }}>
